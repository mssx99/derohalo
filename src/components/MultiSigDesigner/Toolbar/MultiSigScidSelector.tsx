...
import { setContract, useContract } from 'hooks/multiSigHooks';
...
const MultiSigScidSelector: React.FC = () => {
    ...
    return <ScidSelector value={scid} onChange={handleChange} onEnter={handleEnter} type={'MULTISIGNATURE'} />;
};

export default MultiSigScidSelector;
