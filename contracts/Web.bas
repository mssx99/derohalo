// WebContract - USE AT YOUR OWN RISK
...
1 IF STRLEN(alias)<=20 && STRLEN(description)<=100 && STRLEN(destAccount)<70 THEN GOTO 3
2 RETURN 1
3 DIM signer as String
4 DIM fee as Uint64
5 LET signer=SIGNER()
...
1 IF STRLEN(scid)<70 && STRLEN(market)<30 THEN GOTO 3
2 RETURN 1
